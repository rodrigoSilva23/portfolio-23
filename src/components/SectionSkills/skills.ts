export const skills = [
  {
    ...
    description:'Manipulação do dom,Fetch API, Uso das novas funcionalidade do ES6.',
  ...
  },
  {
    ...
    description: "manipulação das tag html5 e sua sintaxe, com enfase na acessibilidade.   ",
  ...
  },
  {
    ...
    description:
      "uso do display:'grid/flex', enfase na responsive e na experiencia do usuário.",
  ...
  },
  {
    ...
    description: "experiencia com consulta,inserção e atualização, eventos, Procedures,subconsultas,   criação de tabela em tempo de execução, entre outras ",
  ...
  },
  {
    ...
    description: "experiencia com os comando:push,pull,commit, stash, merge,checkout,branch ",
  ...
  },
  {
    ...
    description: "leve experiencia com uso de container do docker. ",
